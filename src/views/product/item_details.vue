        ...
        <div class="content_detail">
          ...
          <div class="detail_right">
            ...
            <div class="box_intro" v-if="product_index == 2">
              ...
              ship directly in the mail. It looks great in any color and works
              for retail-ready gift boxes, subscription boxes, and e-commerce
              packaging.
            </div>
            <div class="box_ps" v-if="product_index == 2">
              <div class="">PS:</div>
              <div class="">
                1. Key in length, width, height and quantity you desired.
              </div>
              <div class="">2. Check for the TOTAL PRICE.</div>
              <div class="">
                3. Get quote and our customer service will contact you shortly.
              </div>
            </div>
    ...
    meta: [
      {
        name: "description",
        content:
          "A versatile custom mailer box that's stylish, sturdy and ready to ship directly in the mail.",
      },
    ],
  },
  mounted() {},
            ...
            if (Number(this.box.quantity) == 0) {
              ...
              if (
                ...
                this.box.total_price =
                  this.rel_price_per * this.box.quantity + 80;
              }
            }
          }
        }
